...
#include "create_msgs/msg/detail/sphere__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const create_msgs::msg::Sphere & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  create_msgs::msg::Sphere & ros_message)
{
  // Member: center
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = create_msgs::msg::Sphere;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const create_msgs::msg::Sphere *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<create_msgs::msg::Sphere *>(
    untyped_ros_message);
...
{
  return &create_msgs::msg::typesupport_fastrtps_cpp::_Sphere__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, create_msgs, msg, Sphere)() {
  return &create_msgs::msg::typesupport_fastrtps_cpp::_Sphere__handle;
}
