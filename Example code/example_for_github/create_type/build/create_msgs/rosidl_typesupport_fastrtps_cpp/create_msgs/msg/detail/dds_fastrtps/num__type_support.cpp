...
#include "create_msgs/msg/detail/num__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const create_msgs::msg::Num & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  create_msgs::msg::Num & ros_message)
{
  // Member: num
  cdr >> ros_message.num;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = create_msgs::msg::Num;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const create_msgs::msg::Num *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<create_msgs::msg::Num *>(
    untyped_ros_message);
...
{
  return &create_msgs::msg::typesupport_fastrtps_cpp::_Num__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, create_msgs, msg, Num)() {
  return &create_msgs::msg::typesupport_fastrtps_cpp::_Num__handle;
}
