...
bool create_msgs__msg__sphere__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("create_msgs.msg._sphere.Sphere", full_classname_dest, 30) == 0);
  }
  create_msgs__msg__Sphere * ros_message = _ros_message;
  {  // center
...
PyObject * create_msgs__msg__sphere__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("create_msgs.msg._sphere");
