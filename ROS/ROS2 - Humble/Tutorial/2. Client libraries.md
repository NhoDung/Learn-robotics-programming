...
# 4 Example
## 1. Example: Create a workspace + Clone a repository + Build
```bash
...
## 2. Example: Create a simple package with simple "Hello World" node
```bash
...
## 3. Example: Writing a simple publisher - subscriber by C++
...
> [!question] Problem 1: Create a workspace & a basic package ? 

> [!question] Problem 2: Write Pub/Sub by C++ ?

> [!question] Problem 3: Write Pub/Sub by Python ?
